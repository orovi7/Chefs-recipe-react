...
const Recipe = ({recipe}) => {
    ...
    return (
        <div className='border-2 border-[#28282833] rounded-lg mb-3 p-5'>
          {/* image here */}
          <div className='rounded-lg mb-3'> <img className='' src={recipe_image} alt="" /></div>
          {/* header here */}
          ...
          <div className='flex justify-between mt-5 mb-5'>
            <span className='flex items-center gap-2'><IoTimeOutline /> {preparing_time} minutes</span>
            <span className='flex items-center gap-2'><FaFire /> {calories}</span>
          </div>

          <button className='bg-[#0BE58A] rounded-3xl text-black font-semibold border-2 border-[#0BE58A] flex justify-start p-2 px-3'>Want to cook</button>
